    ...
    <div className="chatbot-container-ch">
      ...
      <div className="chatbot-content-ch">
        ...
        <div id="user-input-container-ch">
          ...
          <button id="clear-button" onClick={handleClearButtonClick}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="trash w-6 h-6 hover:stroke-red-500">
